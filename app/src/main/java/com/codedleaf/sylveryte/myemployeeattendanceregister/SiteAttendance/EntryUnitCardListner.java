 ...
 */
public class EntryUnitCardListner implements View.OnClickListener {
    ...
    public EntryUnitCardListner(Context context, Entry entry, CardView cardView)
    {
        mEntry=entry;
        mContext=context;
        mGolaCard=cardView;
    ...
    public void setColorOfCardAndState(int which)
    {
        switch (which)
        {
            case 0: mEntry.setRemark(Entry.PRESENT); updateEntry();
                break;
            case 1: mEntry.setRemark(Entry.LATE); updateEntry();
                break;
            case 2: mEntry.setRemark(Entry.HALF_TIME); updateEntry();
                break;
            case 3: mEntry.setRemark(Entry.OVER_TIME); updateEntry();
                break;
            case 4: mEntry.setRemark(Entry.ABSENT); updateEntry();
                break;
            case 5: mEntry.setRemark(Entry.NOTSPECIFIED); updateEntry();
                break;
            case 6:
            {
                AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
